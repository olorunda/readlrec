...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/daterangepicker.min.css')); ?>">
...
<body style="background:url('<?php echo e(asset('img/bg.png')); ?>')">
...
_________________________________________________________ -->
	...
	$(function(){
		...
		<?php if(session('messagepre')): ?>
			swal('Error','<?php echo e(session("messagepre")); ?>','error');
		<?php endif; ?>
