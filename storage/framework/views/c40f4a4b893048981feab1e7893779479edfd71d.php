                ...
                <div class="container">
                    <div class="homepage owl-carousel">
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo e(asset('img/banners/worker1.jpg')); ?>" alt="">
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo e(asset('img/banners/graduation.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo e(asset('img/banners/oilandgas.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row portfolio">
                            <div class="col-sm-4">
                                <div class="box-image">
                                    <div class="image">
                                        <img src="<?php echo e(asset('img/portfolio/tsabanner1.jpg')); ?>" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="name">
                            ...
                            <div class="col-sm-4">
                                <div class="box-image">
                                    <div class="image">
                                        <img src="<?php echo e(asset('img/portfolio/hsebanner.jpg')); ?>" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="name">
