                      ...
                      <div class="">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
									<?php foreach($allpos as $aval_pos): ?>
                                        <tr>
                                            <th><input type="checkbox" name="select[]" value="<?php echo e($aval_pos->id); ?>"/></th>
                                            <th><?php echo e($index++); ?></th>
                                            <td><?php echo e($aval_pos->ref_no); ?></td>
                                            <td><?php echo e($aval_pos->position); ?></td>
                                            <td><?php echo e($aval_pos->qualification); ?></td>
                                            <td><?php if($aval_pos->type=="1"): ?> Graduate Trainee <?php else: ?> Experience Hire <?php endif; ?></td>
                                           
											<td><div class="btn-group">
  <button type="button" class="btn btn-sm btn-danger" style="width:50px;" onclick="deleteposition('<?php echo e($aval_pos->id); ?>')"><i class="fa fw fa-times"></i>D</button>
  <button type="button" class="btn btn-success btn-sm" style="width:50px;"   data-toggle="modal" data-target="#myModal<?php echo e($aval_pos->id); ?>"><i class="fa fw fa-pencil-square-o"></i>M</button></div>
</td> 
 <div id="myModal<?php echo e($aval_pos->id); ?>" class="modal fade" role="dialog" >
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
		<p><b>Category</b></p>
		 <select class="form-control" id="jobcat<?php echo e($aval_pos->id); ?>" value="<?php echo e($aval_pos->type); ?>" class="form-control" >
							<option value="1">Graduate Trainee</option>
							<option value="2">Experienced Hire</option>
							</select>
		<br>
		<p><b>Ref No</b></p>
		<input type="text" id="ref_no<?php echo e($aval_pos->id); ?>" value="<?php echo e($aval_pos->ref_no); ?>" disabled class="form-control" /> 
		<br>
		<p><b>Position</b></p>
		<input type="text" id="title<?php echo e($aval_pos->id); ?>" placeholder="Architect, Field Engineer" value="<?php echo e($aval_pos->position); ?>" class="form-control" /> 
		<br>
		<p><b>Qualification Required</b></p>
		<input type="text" id="qualificationrequired<?php echo e($aval_pos->id); ?>" class="form-control" value="<?php echo e($aval_pos->qualification); ?>" placeholder="example include Bsc ,HND" /> 
		<br>
		
		
		<br>
		<button class="btn btn-md btn-success" onclick="modifypos('<?php echo e($aval_pos->id); ?>')"><i class="fa fw fa-edit"></i>MODIFY</button>
			</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							...
							<?php endif; ?>
                            <!-- /.table-responsive -->
						<div class="pull-right"><?php echo $allpos->render(); ?></div>
                        </div>
						<!-- /.table-responsive -->
