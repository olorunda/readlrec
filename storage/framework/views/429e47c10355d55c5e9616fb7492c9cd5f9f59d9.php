...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/twitter.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(asset('css/print.css')); ?>" type="text/css" media="print" />
   <link rel="stylesheet" href="<?php echo e(asset('css/morris.css')); ?>" type="text/css" media="print" />
    <!-- Theme stylesheet, if possible do not edit this stylesheet -->
    <link href="<?php echo e(asset('css/style.green.css')); ?>" rel="stylesheet" id="theme-stylesheet">
...
<![endif]-->
    ...
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon" />
	 ...
	 <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/dropzone.min.css')); ?>">
    <!-- owl carousel css -->
...
<body style="background:url('<?php echo e(asset('img/bg.png')); ?>')" onload="">
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="/">
                                <img src="<?php echo e(asset('img/logo_res.png')); ?>" alt="DPR LOGO"  id="logo">
                        ...
                        <div class="navbar-collapse collapse" id="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
								    ...
								    <?php if(Auth::guest()): ?>
                                    <li class="<?php echo e(active('register')); ?>">
                                        <a href="<?php echo e(url('/register')); ?>">&nbsp;Register&nbsp;</a>
                                    </li>
                                    <li class="<?php echo e(active('login')); ?>">
									...
									<?php else: ?>
									<?php if(Auth::user()->type=="1"): ?>	
                                    <li class="<?php echo e(active('panel')); ?>">
                                        <a href="<?php echo e(url('panel')); ?>" >&nbsp;Admin&nbsp;</a>
                                    </li>
									<?php endif; ?>
									<?php if(Auth::user()->progress=="5" && Auth::user()->type=="0"): ?>
									  <li class="<?php echo e(active('profile/*')); ?>">
                                        <a href="<?php echo e(url('profile')); ?>/<?php echo e(Crypt::encrypt(Auth::user()->id)); ?>">&nbsp;Profile&nbsp;</a>
                                    </li>
                                    <?php else: ?>
                                    <?php if(Auth::user()->type==1): ?>
                                    <?php else: ?>
                                    	 <li class="<?php echo e(active('jobtype')); ?>">
                                        <a href="<?php echo e(url('jobtype')); ?>">&nbsp;Profile&nbsp;</a>
                                    </li>
                                    <?php endif; ?>
									<?php endif; ?>
									<li >
...
_________________________________________________________ -->
	<script src="<?php echo e(asset('js/jquery.js')); ?>" ></script>
	 <script src="<?php echo e(asset('js/timer.jquery.js')); ?>"></script>
	<?php if(Auth::guest()): ?>
	...
	function reset(){
		...
		text: "You are about restart your application",  
		type: "warning",   
		...
		$.get('/restart',function(data,status,xhr){
			
			if(data=="success"){
					
					window.location='/jobtype';
					
				
			}
			else{
				 swal("Cancelled", "Some Error Occured, Pleae Try Again Later", "error");  
			}
			
		});
			
		   } 
		else {     swal("Cancelled", "Restart Cancelled", "error");   } });
	...
	if(sessionStorage.getItem('count')==undefined){
		...
		text: "<span style='font-size:20px;'>This Portal is designed By <b><a href='http://www.snapnet.com.ng'>Snapnet Limited.</a></span><br><span style='text-align:center'><img src='<?php echo e(asset('img/snapnet.png')); ?>'> </span>",  
		html: true });
...
function submit(){
	...
	$.get('/quest/submittest/'+<?php echo e(Auth::user()->id); ?>+'/'+questionid+'/'+selectedoption,function(data,status,xhr){
   ...
   if(sessionStorage.getItem('started')==1){
	...
	swal('Success','Test Submitted Successfully','success');
		...
		<?php if(session('messagepre')): ?>
			swal('Warning','<?php echo e(session("messagepre")); ?>','warning');
		<?php endif; ?>
		$('#enabled').hide();
		...
		//=============================================================
			...
			<?php if(is_active('report')): ?>
			
 
   function appperregion(){
   $.get('/appperregion',function(data,status,xhr){
...
function sexstat(){
$.get('/getsexstat',function(data,status,xhr){
...
$.get('/appbystate',function(data,xhr,status){
...
function dataautoupdate(){
	$.get('/appbystate',function(data,status,xhr){
	donut.setData(data);
	});
	...
	$.get('/yearlystat',function(data,status,xhr){
		liveyear.setData(data);
	});
	
	$.get('/passfail',function(data,status,xhr){
...
<?php endif; ?>
		...
		<?php if(session('regsuccess')=="success"): ?>
		...
		//search applicant
			<?php if(Auth::guest()): ?>
		<?php else: ?>
			<?php if(isset($user->ref_num)): ?>
		$("#demo").barcode(
		  	"<?php echo e($user->ref_num); ?>", // Value barcode (dependent on the type of barcode)
		  	"code128" // type (string)
		);
		<?php endif; ?>
		<?php endif; ?>
