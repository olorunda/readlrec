    ...
    <table class="table table-hover table-stripped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    <form class="inline-form" action="<?php echo e(url('/deletequals')); ?>/<?php echo e($qual->id); ?>" method="POST">
        ...
        <tbody>
		 <?php $index=1; ?>
            ...
            <tr>
                ...
                <th>
                    <form class="inline-form" action="<?php echo e(url('/deleteexp')); ?>/<?php echo e($exp->id); ?>" method="POST">
                        <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                        <input type="hidden" name="_method" value="DELETE">
                        <button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button>
                    </form>
    ...
    <table class="table table-hover table-stripped">
        ...
        <?php $index=1; ?>
            ...
            <tr>
                ...
                <th>
                    <form class="inline-form" action="<?php echo e(url('/deleteref')); ?>/<?php echo e($ref->id); ?>" method="POST">
                        <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                        <input type="hidden" name="_method" value="DELETE">
                        <button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button>
                    </form>
