...
<?php endforeach; ?>
                                          ...
                                          <!--  <td><a href="/download/<?php echo e($applicant->id); ?>" class="btn btn-template-main btn-sm"><I class="fa fa-download"></i>Download</a> </td> -->
											<td><a  class="btn btn-template-main btn-sm" data-toggle="modal" data-target="#profpop<?php echo e($applicant->id); ?>"><i class="fa fa-eye"></i>View</a>
                                           
										   
										   <div id="profpop<?php echo e($applicant->id); ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-lg" style="margin-left:-15%;">
      ...
      <div class="modal-body">
	   ...
	   <iframe  style="border:none; width:100%; height:1000px;" src="<?php echo e(url('/profile')); ?>/<?php echo e(Crypt::encrypt($applicant->id)); ?>" > </iframe>
      </div>
