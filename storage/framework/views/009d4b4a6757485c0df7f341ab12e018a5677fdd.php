 ...
 <!--display the table here -->
    ...
    <div>
                             ...
                             <input type="hidden" name="id" id="id" value="<?php echo e(Auth::User()->id); ?>">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                            <label for="my-dropzone-files">Upload in the following order:&emsp; <li>N.Y.S.C Discharge/ exemption  Certificate </li><li> Higher Institution Certificate</li><li> Secondary School leaving Certificate</li> <?php if(Auth::user()->jobcat==2): ?> <li>Certificate from recognised professional bodies</li><li>Evidence of Previous experience</li> <?php endif; ?> </label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-8 col-sm-11">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="iname" id="iname" value="<?php if(isset($inst->iname)): ?> <?php echo e($inst->iname); ?> <?php endif; ?>" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-8 col-sm-11">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="course" id="course" value="<?php if(isset($inst->iname)): ?> <?php echo e($inst->course); ?> <?php endif; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
