...
<div class="media">
    <div class="media-left">
        <a href="#">
            <img src="<?php echo e(asset('img/stdtrain.jpg')); ?>" style="height:100px; width:100px;" class="media-object" alt="Sample Image">
        </a>
    </div>
...
<div class="media">
    <div class="media-left">
        <a href="#">
            <img src="<?php echo e(asset('img/stdtrain2.jpg')); ?>" style="height:100px; width:100px;" class="media-object" alt="Sample Image">
        </a>
    </div>
    <div class="media-body" style="font-size:17px;">
