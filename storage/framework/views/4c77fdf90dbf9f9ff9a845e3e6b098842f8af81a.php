                                ...
                                <div class="col-md-10">
                                    <div class="col-md-5">
                                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="first_name" value="<?php echo e(Auth::User()->f_name); ?>" disabled="disabled">
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="last_name" value="<?php echo e(Auth::User()->l_name); ?>" disabled="disabled">
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="middle_name" id="middle_name" value="<?php echo e(Auth::User()->m_name); ?>">
                                        </div>
                                ...
                                <div class="col-md-10" id="maiden">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="maiden_name" id="maiden_name" value="<?php echo e(Auth::User()->maiden_name); ?>">
                                        </div>
                                ...
                                <div class="col-md-10">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" id="email-login" value="<?php echo e(Auth::User()->email); ?>" disabled="disabled">
                                        </div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-5">
                                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone_number" id="phonenumber" value="<?php echo e(Auth::User()->phone_num); ?>">
                                        </div>
