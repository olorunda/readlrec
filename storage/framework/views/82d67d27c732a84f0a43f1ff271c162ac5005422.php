        ...
        <div id="content">
            <div class="container" style="background-color:white; padding-top:50px;">
			 ...
			 _________________________________________________________ -->
			 	<div class="col-md-9">
				<div class="col-md-12" style="margin-top:1%; margin-bottom:4%;"><h3 class="text-center  " style="text-transform:uppercase">Applicant Statistical Data's</h3><br><div class="text-center"><button class="btn btn-template-main btn-sm "id="refresh"><i class="fa fa-refresh"></i>Refresh Data</button></div></div>
